...
void HAL_TSC_MspInit(TSC_HandleTypeDef* tscHandle)
{
  ...
  /* USER CODE END TSC_MspInit 0 */
    ...
    PA5     ------> TSC_G2_IO2 
    */
    GPIO_InitStruct.Pin = TSC_G2_SAMPLING_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TSC;
    HAL_GPIO_Init(TSC_G2_SAMPLING_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = TSC_G2_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TSC;
    HAL_GPIO_Init(TSC_G2_IN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TSC_MspDeInit(TSC_HandleTypeDef* tscHandle)
{
  ...
  /* USER CODE END TSC_MspDeInit 0 */
    ...
    PA5     ------> TSC_G2_IO2 
    */
    HAL_GPIO_DeInit(GPIOA, TSC_G2_SAMPLING_Pin|TSC_G2_IN_Pin);
